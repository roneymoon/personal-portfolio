      ...
      <div className="border-l border-r ml-8 mr-8 px-4 border-gray-200/30">
        <h2 className="text-4xl md:text-5xl lg:text-6xl flex flex-col overflow-hidden"> 
          <motion.span className="whitespace-nowrap" style={{x: transformTop}}>
            some nice words from my past clients some nice words from my past clients some nice words from my past clients
          </motion.span>
          <motion.span className="whitespace-nowrap self-end text-amber-400" style={{y: transformBottom}}>
            some nice words from my past clients some nice words from my past clients some nice words from my past clients
          </motion.span>
        </h2>
